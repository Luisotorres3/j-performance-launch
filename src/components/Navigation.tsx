...
const Navigation = () => {
  ...
  return (
    <header>
      ...
      {isOpen && (
        <div className="fixed left-0 right-0 bottom-0 md:hidden" style={{ top: '64px', zIndex: 60 }}>
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-background via-background to-muted/30 animate-in slide-in-from-top duration-300 overflow-y-auto">
            <div className="container mx-auto px-6 py-8 min-h-full flex flex-col">
              ...
              <div className="mt-8 px-2 animate-in slide-in-from-bottom duration-500" style={{ animationDelay: '0.4s', animationFillMode: 'backwards' }}>
                <Button 
                  asChild 
                  size="lg" 
